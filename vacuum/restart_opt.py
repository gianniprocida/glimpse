...
mylist=[f"%oldchk={oldchk}",chk,'%mem=16GB','%NProcShared=10',f"# pbepbe/gen pseudo=read Opt=Tight Int=UltraFine Freq Geom=Check Guess=Read empiricaldispersion=gd3bj",'',name,'','0 1','']
